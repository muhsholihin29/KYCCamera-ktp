...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        camera = CameraUtils.openCamera(mCameraFacing);
        if (camera != null) {
            try {
                ...
                float screenMinSize = Math.min(ScreenUtils.getScreenWidth(mContext), ScreenUtils.getScreenHeight(mContext));
                float screenMaxSize = Math.max(ScreenUtils.getScreenWidth(mContext), ScreenUtils.getScreenHeight(mContext));
                Camera.Size bestSize = getOptimalPreviewSize(sizeList, (int) screenMaxSize, (int) screenMinSize);
//                Camera.Size bestSize = getBestPreviewSize(ScreenUtils.getScreenHeight(mContext), ScreenUtils.getScreenWidth(mContext));
